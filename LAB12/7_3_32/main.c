...
struct element* Lista_bez_Glowy_polacz_naprzemiennie(struct element*Lista1, struct element*Lista2)
{
...
struct element* Lista_z_Glowa_polacz_naprzemiennie(struct element*Lista1, struct element*Lista2)
{
    struct element* temp1;
    struct element* temp2;
    if(Lista1->next==NULL)
        return NULL;
    temp1=temp2=Lista1->next;
    Lista1=Lista1->next;
    temp2=Lista2;
    temp2=Lista2;
    Lista2=Lista2->next;
...
int main()
{
    ...
    struct element* lista3=Lista_bez_Glowy_polacz_naprzemiennie(lista1, lista2);
    ...
    struct element* lista6=Lista_z_Glowa_polacz_naprzemiennie(lista4, lista5);
